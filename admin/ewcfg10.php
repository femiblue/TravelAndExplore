...
define("EW_PROJECT_ID", "{75D8DC58-3D90-4206-8D81-1D4FF2853B57}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'J12112Ev7c3vPKWm', TRUE); // Random key for encryption
...
define("EW_CONN_DB", 'meirunas_travel', TRUE);
...
define("EW_ADMIN_PASSWORD", "meirunas", TRUE); // Administrator password
