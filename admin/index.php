...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("filterlist.php"); // Exit and go to default page
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("flightlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("hotellist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("roomlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("dialogue_ruleslist.php");
		if ($Security->IsLoggedIn()) {
