        			...
        			<div class="col-sm-12">
                        ...
                        <div style="text-align: center;" >
                          <div style=" display: inline-table; margin-right: 12px; border: 1px solid #ddd; padding:5px;">
                            ...
                            <br />  <br /> 
                            <form action="<?php echo $my_base_url.'order/pay_with_cards'; ?>" method="POST">
                              <script
                        ...
                        <!-- end owl-hotel-offers  create a charge and complete the payment.on stripe for real transactions-->
